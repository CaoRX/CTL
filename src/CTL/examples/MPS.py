...
def createRandomMPS(n, dim, chi):
    # TODO: this random element mps is not a really random MPS
    # the MPS with every element generated by randn is somehow random
    # need random matrix by QR decomposition
    # 0 / n - 1: (2, chi)
    # others: (2, chi, chi)
    tensors = []
