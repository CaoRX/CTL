...
#         self.tensors = dict()
#         tensorNames = ['ulcorner', 'urcorner', 'dlcorner', 'drcorner']
#         tensorNames += ['ledge', 'redge', 'uedge', 'dedge']

#         for tensorName in tensorNames:
#             self.tensors[tensorName] = self.a.copy()

#         for tensorName in tensorNames:
#             if tensorName.find('corner') != -1:
#                 self.tensors[tensorName].sumOutLegByLabel([tensorName[0], tensorName[1]])
#             elif tensorName.find('edge') != -1:
#                 self.tensors[tensorName].sumOutLegByLabel([tensorName[0]])
...
#         self.tensors, error = self.reduceDimension(self.tensors)
...
#         tensorNames = ['ulcorner', 'urcorner', 'dlcorner', 'drcorner']
#         tensorNames += ['ledge', 'redge', 'uedge', 'dedge']
#         for tensorName in tensorNamess:
...
#     def reduceDimension(self, tensors):
